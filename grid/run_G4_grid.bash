...
export LD_LIBRARY_PATH=/data2/wenzel/gputest1_10.7.p01/CaTS-install/bin/:$LD_LIBRARY_PATH
...
EOF
#/bin/more run_G4.mac
cp  /data2/wenzel/gputest1_10.7.p01/CaTS/macros/*.mac .
/data2/wenzel/gputest1_10.7.p01/CaTS-install/bin/CaTS -gdml /data2/wenzel/gputest10/CaTS-install/bin/crystalcal_pbwo.gdml -pl ${PHYSLIST} -macro pip_IO_DR2.mac
/bin/date
